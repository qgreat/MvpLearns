 ...
 */
package com.memory.citedown.component.service;
 ...
 * ================================================
 */
@Route(path = RouterHub.CITE_SERVICE_CITEINFOSERVICE, name = "Citetttt")
public class CiteInfoServiceImpl implements CiteInfoService {
	private Context mContext;

	@Override
	public CiteInfo getInfo() {
		return new CiteInfo("Cite");
	}
