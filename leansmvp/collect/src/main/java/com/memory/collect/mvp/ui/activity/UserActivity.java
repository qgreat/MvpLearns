...
import com.memory.collect.di.component.DaggerUserComponent;
import com.memory.collect.mvp.contract.UserContract;
import com.memory.collect.mvp.presenter.UserPresenter;
...
public class UserActivity extends BaseActivity<UserPresenter> implements UserContract.View {
	...
	public int initView(@Nullable Bundle savedInstanceState) {
		return R.layout.collect_activity_user; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
	}
