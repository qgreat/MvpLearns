 ...
 * @time 2017-9-6 9:23
 */
public abstract class YeSearchFragmentActivity< P extends YeSearchIPresenter> extends BaseUiActivity< P>  implements YeSearchView {
    protected String TAG_PRE = "ye_Search";
    ...
    private FrameLayout yeSearchFrame;
    ...
    public abstract Fragment getFragment(String query);
    @Override
    ...
    public int getContentViewId() {
        return R.layout.yeyue_common_search_fragment;
    }
    ...
    public void findView() {
        ...
        yeSearchFrame = (FrameLayout) findViewById(R.id.yeSearchFrame);
    ...
    public void initFragment(String query){
        fragmentManager = getSupportFragmentManager();
        fragmentTransaction = fragmentManager.beginTransaction();
        Fragment  fragment = getFragment(query);
        if (fragment != null) {
            fragmentTransaction.add(R.id.yeSearchFrame,fragment);
    ...
    protected void searchQuery(String word){
        edtContent.setText(word);
        toSearch();
    }
    //开始搜索
            ...
            if (open) {
                ...
                animHistory5.addListener(new Animator.AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        if (yeSearchFrame.getVisibility() == View.VISIBLE)
                            yeSearchFrame.setVisibility(View.GONE);
                    }
                ...
                animHistory5.addListener(new Animator.AnimatorListener() {
                    ...
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        yeSearchFrame.setVisibility(View.VISIBLE);
